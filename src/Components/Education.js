    ...
    <div className="my-64">
      ...
      <div ref={ref1} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between xs:ml-2">
          <Details
            type="Integrated M.Tech in Computer Science and Engineering Specialization in Cyber Security" 
            time="2021-2026 "
            place=" National Forensic Sciences University, Delhi "
            info="Delhi,India"
          />
          <Details
            type="12th board (CBSE)"
            time="2021 "
            place="D.A.V centenary Public School, Haridwar"
            info="Haridwar, Uttarakhand, India"
          />
        </ul>
      </div>
    </div>

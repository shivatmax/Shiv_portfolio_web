...
const Skills = () => {
  return (
    <>
      ...
      initial={{x:0,y:0}}
    >
      <a href="https://www.linkedin.com/in/shiv-awasthi/" className=" text-4xl">🌍</a>
    </motion.div>
        <Skill name="REACT - NextJS" x="30vw" y="0vw"/>
        <Skill name="C/C++" x="0vw" y="10vw"/>
        <Skill name="Artificial Intellegence" x="0vw" y="20vw"/>
        <Skill name="TailwindCSS" x="-30vw" y="0vw"/>
        <Skill name="AWS" x="0vw" y="-10vw"/>
        <Skill name="JAVA" x="25vw" y="20vw"/>
        <Skill name="DSA" x="-25vw" y="20vw"/>
        <Skill name="Python" x="0vw" y="-20vw"/>
        <Skill name="MONGO/SQL DB" x="25vw" y="-10vw"/>
        <Skill name="CyberSecurity" x="-23vw" y="-10vw"/>
        <Skill name="ML / NLP" x="-25vw" y="10vw"/>
        <Skill name="LLM" x="29vw" y="10vw"/>
        <Skill name="Flutter" x="-25vw" y="-20vw"/>
        <Skill name="Typescript" x="25vw" y="-20vw"/>
      </div>
    </>
  );
};
